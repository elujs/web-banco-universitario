<template>
  <section id="faqs-seccion" class="py-12 md:py-20 bg-white font-sans">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
        <div class="space-y-4 w-full">
          ...
          >
            ...
            >
              <div
                class="px-6 pb-6 text-gray-500 text-sm md:text-base leading-relaxed border-t border-gray-200/40 pt-4"
              >
                {{ faq.respuesta }}
              </div>
            </div>
        ...
        <div class="relative w-full">
          <div
            class="relative rounded-[32px] overflow-hidden shadow-xl border border-gray-100 h-[420px]"
          >
            <div
            ...
            >
              ...
              <div
                class="absolute inset-0 bg-gradient-to-t from-gray-900/30 to-transparent pointer-events-none"
              ></div>
            </div>
            ...
            <div class="absolute bottom-5 left-1/2 transform -translate-x-1/2 z-20 flex gap-2">
              <button
                ...
                :class="
                  currentSlide === index ? 'w-6 bg-[#085F63]' : 'w-2 bg-white/60 hover:bg-white'
                "
              ></button>
            </div>
          </div>
...
const faqs = ref([
  {
    ...
    respuesta:
      'Para abrir tu cuenta solo necesitas ser estudiante activo o personal de la universidad asociada, presentar tu documento de identidad vigente y tu carnet universitario o constancia de inscripción.',
  },
  {
    pregunta: '¿Tiene algún costo de mantenimiento la cuenta?',
    respuesta:
      'No, la cuenta de Banco Universitario está completamente libre de comisiones por manejo de cuenta, saldos mínimos o mantenimiento mensual.',
  },
  {
    pregunta: '¿Cómo puedo realizar depósitos en mi cuenta?',
    respuesta:
      'Puedes realizar depósitos en efectivo en cualquiera de nuestras sucursales físicas habilitadas, puntos de atención autorizados o mediante transferencias interbancarias directas.',
  },
  {
    pregunta: '¿Qué hago si pierdo mi tarjeta?',
    respuesta:
      'En caso de pérdida o robo, puedes bloquear tu tarjeta de inmediato desde nuestra aplicación móvil o comunicarte directamente a nuestra línea de atención al cliente para solicitar una reposición segura.',
  },
])

...
<template>
  <div class="flex flex-col sm:flex-row gap-4 mb-8">
    <!-- Contenedor 1: El cuadradito que encierra el logo -->
    <div class="bg-white px-6 py-6 rounded-xl border border-gray-100 shadow-sm flex items-center justify-center shrink-0">
      <img :src="logoImage" alt="Banco Universitario" class="h-9 w-auto object-contain" />
    </div>

    <!-- Contenedor 2: El que encierra el saludo, notificaciones y perfil -->
    <header class="bg-white px-8 py-6 rounded-xl border border-gray-100 shadow-sm flex-1 flex justify-between items-center">
      <div>
      ...
      <!-- Contenedor derecho: Notificaciones y Menú de usuario -->
